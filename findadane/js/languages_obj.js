var languages_obj = function() {
    ...
    var load = function() {
        var select_option = document.getElementById("language_options");
    ...
    var language_selected = function(elem) {
        ...
        document.getElementById("language_value").textContent = selected_name;
        var language_name = selected_name.split(" ").join("_");
        language_name = language_name.split("'").join("_");
        language_name = language_name.split("/").join("_");
        get_userdata_obj.update_language(language_name.toUpperCase());
    };
